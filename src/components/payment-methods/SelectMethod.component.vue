      ...
      <div class="donation-amount">
        ...
        <div class="donation-buttons">
          ...
          <button
            ...
            @click="selectDonationAmount(10)"
          >
            S/ 10
          </button>
          <button
            class="donation-option"
            :class="{ selected: donationAmount === 15 }"
            @click="selectDonationAmount(15)"
          >
            S/ 15
          </button>
          <button
            class="donation-option"
            :class="{ selected: donationAmount === 20 }"
            @click="selectDonationAmount(20)"
          >
            S/ 20
          </button>
